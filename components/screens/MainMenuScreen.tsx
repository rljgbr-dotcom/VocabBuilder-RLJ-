...
const MainMenuScreen: React.FC<MainMenuScreenProps> = ({ handleCheckForUpdate }) => {
    ...
    return (
        <div className="text-center space-y-4 pt-12">
            <div className="grid grid-cols-2 gap-4 max-w-2xl mx-auto">
                <MenuButton
                    onClick={() => handleNavigation('game-selection')}
